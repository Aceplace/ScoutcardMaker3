...
class Ui_OffensiveEditor(object):
    def setupUi(self, OffensiveEditor):
        ...
        self.edit_formation_name = QtWidgets.QLineEdit(self.layoutWidget)
        self.edit_formation_name.setObjectName("edit_formation_name")
        self.verticalLayout.addWidget(self.edit_formation_name)
        self.btn_save_formation = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.btn_delete_selected_formation = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 311, 548))
        ...
        self.rb_composite = QtWidgets.QRadioButton(self.groupBox)
        self.rb_composite.setObjectName("rb_composite")
        self.gridLayout_2.addWidget(self.rb_composite, 0, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.groupBox)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 1, 0, 1, 1)
        self.rb_editing = QtWidgets.QRadioButton(self.groupBox)
        self.rb_editing.setObjectName("rb_editing")
        self.gridLayout_2.addWidget(self.rb_editing, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.edit_composite, 1, 1, 1, 1)
        ...
        self.widget_formation_visualization.setGeometry(QtCore.QRect(0, 0, 776, 465))
    ...
    def retranslateUi(self, OffensiveEditor):
        ...
        self.rb_composite.setText(_translate("OffensiveEditor", "Composite"))
        self.label_5.setText(_translate("OffensiveEditor", "Composite Name"))
        self.rb_editing.setText(_translate("OffensiveEditor", "Editing"))
        ...
        self.actionSave_Library.setShortcut(_translate("OffensiveEditor", "Ctrl+S"))
